...
class LocationInput extends StatefulWidget {
  ...
  final void Function(PlaceLocation loaction) onSelectedLocation;
...
class _LocationInputState extends State<LocationInput> {
  ...
  String get locationImage {
    ...
    return 'https://maps.googleapis.com/maps/api/staticmap?center=$lat,$lon&zoom=13&size=600x300&maptype=roadmap&markers=color:red%7Clabel:A%7C$lat,$lon&key=${dotenv.env["google_map_api_key"]}';
  }
